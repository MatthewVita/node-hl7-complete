      ...
      "ORU_R01.ORDER_OBSERVATION": [{
        ...
        "OBR": [{
          ...
          "OBR.4": [{
            ...
            "CE.3": ["LN"],
            "CE.4": ["3456543"],
            "CE.5": ["Blood lead test"],
            "CE.6": ["99USI"]
          }],
          "OBR.7": [{
            "TS.1": ["200808151030-0700"]
          }],
          "OBR.13": ["Diarrhea"],
          "OBR.16": [{
            "XCN.1": ["1234"],
        ...
        "ORU_R01.OBSERVATION": [{
          "OBX": [{
            ...
            "OBX.6": [{
              "CE.1": ["ug/dL"],
              "CE.2": ["micro-gram per deci-liter"],
              "CE.3": ["UCUM"]
            }],
            "OBX.7": ["<9 mcg/dL:  Acceptable background lead exposure"],
            "OBX.8": ["H"],
            "OBX.11": ["F"],
            "OBX.14": [{
              "TS.1": ["200808151030-0700"]
        ...
        "ORU_R01.SPECIMEN": [{
          "SPM": [{
            "SPM.4": [{
              "CWE.1": ["122554006"],
              "CWE.2": ["Capillary blood specimen"],
              "CWE.3": ["SCT"],
              "CWE.4": ["BLDC"],
              "CWE.5": ["Blood capillary"],
              "CWE.6": ["HL70070"],
              "CWE.7": ["20080131"],
              "CWE.8": ["2.5.1"]
            }]
